...
def train_one_group(feat_key: str, seed: int = 0):
    ...
    model_path = Path(MODEL_DIR) / f"optimized_multitask_model__{feat_key}__seed{seed}.pt"
    ...
    cfg_path = Path(MODEL_DIR) / f"optimized_multitask_model__{feat_key}__seed{seed}.json"
