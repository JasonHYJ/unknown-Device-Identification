...
"""
（当前暂未使用的脚本，在最老的版本上进行了目录更新，但没有验证集，只有最终结果，暂不使用）
脚本功能说明：
读取阶段一提取的归一化之后的统计特征、阶段二对比学习后的64维嵌入向量（序列+原始字节，区分闲时/行为）；
...
# --------------------------- 参数配置 ---------------------------
csv_path = "/home/hyj/unknownDeviceIdentification/dataset/11_multitask_training/uk/uk_train.csv"
root_stat = "/home/hyj/unknownDeviceIdentification/dataset/10_contrastive_embeddings/10_contrastive_statistical_embeddings/train/uk"
root_seq = "/home/hyj/unknownDeviceIdentification/dataset/10_contrastive_embeddings/10_contrastive_sequence_embeddings/train/uk"
root_raw = "/home/hyj/unknownDeviceIdentification/dataset/10_contrastive_embeddings/10_contrastive_rawbyte_embeddings/train/uk"
label_dict_dir = "/home/hyj/unknownDeviceIdentification/dataset/11_multitask_training/uk"

output_model_path = "/home/hyj/unknownDeviceIdentification/dataset/11_multitask_training/uk/multitask_model.pt"
...
def train():
    ...
    # 梯度裁剪的代码放在 loss.backward() 之后，optimizer.step() 之前
    max_grad_norm = 2  # 设置最大梯度裁剪值
