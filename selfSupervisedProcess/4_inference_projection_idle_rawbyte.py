# inference_projection_idle_rawbyte.py

"""
📌 功能说明：
本脚本用于加载已训练好的投影模型，对“闲时流量的原始字节嵌入向量（128维）”进行64维投影，
适用于 test/unknown 样本的处理，保持原始路径结构保存。
...
# 参数配置
# ========================
INPUT_ROOT = "/home/hyj/unknownDeviceIdentification/dataset/9_learned_embeddings/9_learned_rawbyte_embeddings/unknown/cicIoT2022"  # or unknown
...
MODEL_PATH = "/home/hyj/unknownDeviceIdentification/selfSupervisedProcess/3rd/cicIoT2022_projection_idle_rawbyte.pt"
