...
plt.ylabel("未知集厂商准确率", fontsize=13, fontfamily='SimSun')
plt.xticks([1, 2, 3, 4, 5])
plt.ylim(0.85, 1.0)
plt.grid(True, linestyle="--", linewidth=0.5, alpha=0.6)
plt.text(0.5, -0.18, "(b)厂商识别结果", transform=plt.gca().transAxes, ha='center', fontsize=14, fontfamily='SimSun')

plt.legend()

plt.tight_layout()
plt.savefig('C:/Users/jiyiy/Desktop/学位论文/论文插图/第五章/图6厂商识别准确率对比折线图中文.pdf', dpi=dpi, bbox_inches='tight', format='pdf')
plt.show()
